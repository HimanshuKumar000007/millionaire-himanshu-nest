...
url = "http://localhost:3000/api/content/mocks?id=nest-pyq-2022-s2&resolve=true"
...
try:
    with urllib.request.urlopen(req) as response:
        ...
        print(f"Q68 Type: {q68.get('questionType')}")
        
        print("\nAll NEST 2022 Session 2 live API verification checks passed successfully!")
